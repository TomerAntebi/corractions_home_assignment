...
class MeasurementModel(Base):
    ...
    raw_timestamp: Mapped[str | None] = mapped_column(String, nullable=True)
    raw_speed: Mapped[str | None] = mapped_column(String, nullable=True)
    raw_wheel_angle: Mapped[str | None] = mapped_column(String, nullable=True)
    raw_reverse_state: Mapped[str | None] = mapped_column(String, nullable=True)
