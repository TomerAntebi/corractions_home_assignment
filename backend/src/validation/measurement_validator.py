...
class MeasurementValidator:
    def validate_measurement(
        ...
        self._collect_sensor_error_issues(measurement, validation_errors, flagged_fields)
        self._collect_non_numeric_issues(measurement, validation_errors, flagged_fields)
        self._collect_missing_required_issues(measurement, validation_errors, flagged_fields)
        self._collect_out_of_range_issues(measurement, validation_errors, flagged_fields)
    ...
    def _collect_sensor_error_issues(
        ...
        for field_name in FIELDS_CHECKED_FOR_SENSOR_ERROR:
            ...
            self._record_validation_error(validation_errors, flagged_fields, validation_error)
